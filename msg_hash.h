...
enum msg_hash_enums
{
   ...
   MENU_ENUM_LABEL_VALUE_INPUT_META_RENAME_STATE_KEY,
   ...
   MENU_ENUM_SUBLABEL_INPUT_META_RENAME_STATE_KEY,
   ...
   MENU_LABEL(RENAME_STATE),
   MENU_LABEL(UNDO_LOAD_STATE),
   MENU_LABEL(UNDO_RENAME_STATE),
   ...
   MENU_LABEL(FRAME_TIME_COUNTER_RESET_AFTER_RENAME_STATE),
